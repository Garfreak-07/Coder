...
| Repo evidence tools | `context/repo_*` | `coder-tools` repo search/read/find | Port path safety and evidence write behavior | Existing repo_search/read/discovery tests have Rust equivalents |
