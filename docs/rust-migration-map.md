...
| Final reports | `agent_graph/final_report.py` | `coder-core::FinalReport` plus report builder | Started with event/repo-evidence-backed report preview/write for Rust runs; expand changed-file and patch refs next | Completed/blocked/failed/cancelled report tests pass |
