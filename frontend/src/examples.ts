...
export const defaultPlannerLedAgentWorkflow: AgentWorkflowSpec = {
  ...
  description: "The chat Planner approves one compact plan. Executor implements and verifies it, then the workflow Planner makes a bounded finish-or-improve decision.",
  ...
  agents: [
    ...
    },
    {
      ...
      model_tier: "best",
      can_talk_to_human: false,
      capabilities: ["read_execution_evidence", "decide_continue_or_finish", "route_repair"]
    }
  ],
  edges: [
